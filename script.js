document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    const nameInput = contactForm.querySelector('input[name="name"], input[placeholder*="name" i], input[placeholder*="שם"]');
    const messageInput = contactForm.querySelector('textarea[name="message"], textarea[placeholder*="message" i], textarea[placeholder*="הודעה"]');
    ...
    function showError(input, message) {
      ...
      if (!errorEl) {
        ...
        errorEl.style.cssText = 'color: red; font-size: 0.875rem; margin-top: 0.25rem; display: block;';
    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      if (isValid) {
        ...
        successMessage.style.cssText = 'color: green; margin-top: 1rem; font-weight: bold;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'df8ccf9b-d988-46cc-9376-af93474ec56a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'df8ccf9b-d988-46cc-9376-af93474ec56a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'df8ccf9b-d988-46cc-9376-af93474ec56a';
